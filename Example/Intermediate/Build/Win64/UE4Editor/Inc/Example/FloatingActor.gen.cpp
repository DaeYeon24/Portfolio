...
#include "Example/FloatingActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	EXAMPLE_API UClass* Z_Construct_UClass_AFloatingActor_NoRegister();
	EXAMPLE_API UClass* Z_Construct_UClass_AFloatingActor();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_runingTime_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_runingTime;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingActor_Statics::NewProp_runingTime_MetaData[] = {
		{ "Category", "FloatingActor" },
		{ "Comment", "// ???? ????\n" },
		{ "ModuleRelativePath", "FloatingActor.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFloatingActor_Statics::NewProp_runingTime = { "runingTime", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingActor, runingTime), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AFloatingActor_Statics::NewProp_runingTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingActor_Statics::NewProp_runingTime_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloatingActor_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloatingActor_Statics::NewProp_runingTime,
	...
	IMPLEMENT_CLASS(AFloatingActor, 2509035328);
	template<> EXAMPLE_API UClass* StaticClass<AFloatingActor>()
	{
		return AFloatingActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloatingActor(Z_Construct_UClass_AFloatingActor, &AFloatingActor::StaticClass, TEXT("/Script/Example"), TEXT("AFloatingActor"), false, nullptr, nullptr, nullptr);
